...
- [ ] 6.3 Confirmar que el job pasa en un runner limpio de GitHub Actions (sin estado previo de Docker) — pendiente: requiere push/PR real, confirmar con el mantenedor antes
